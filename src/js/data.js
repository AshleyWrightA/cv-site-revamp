...
export default {
  storefront: {
    ...
    section_3:
      "I would give each shop item its own page (dynamic routing) when clicked, proper filtering, product search, and calculating the total cost of each product in the cart.",
  },
  jobrunner: {
    title: "JobRunner",
    img: "",
    alt: "",
    section_1: "JobRunner is meant to be a fullstack showcase web app.",
    section_2:
    ...
    section_3: "As the project is in progress, i'm still implementing core functionality.",
  },
  geekchartr: {
    title: "GeekChartr",
    img: geekChartrInfo,
  ...
  password: {
    ...
    section_2: "Basics of reading & writing data in python and building out a software GUI.",
    section_3:
